...
import { ADMIN_EMAIL, PERSON_COLORS, householdMembers } from './config.js';
...
function App() {
  ...
  // FIXED: Redirect to dashboard on sign-in
  useEffect(() => {
    // If there was no user before (prevUser is null/undefined) AND there is a user now, it means they just logged in.
    if (!prevUser && user) {
      navigate('/');
    }
