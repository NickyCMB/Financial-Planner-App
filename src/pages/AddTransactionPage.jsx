...
const AddTransactionPage = () => {
    ...
    const handleAddTransaction = async (e) => {
        ...
        try {
            await addDoc(collection(db, 'users', HOUSEHOLD_ID, 'transactions'), {
                description,
        ...
        <div className="page-content">
            <form className="transaction-form" onSubmit={handleAddTransaction}>
                <div className="form-control">
                    ...
                    <input type="text" id="description" placeholder="z.B. Miete, Gehalt..." value={description} onChange={(e) => setDescription(e.target.value)} />
                </div>
                <div className="form-control">
                    <label htmlFor="amount">Betrag (€)</label>
                    <input type="text" id="amount" placeholder="0,00" value={amount} onChange={(e) => setAmount(e.target.value)} />
                </div>
                <div className="form-control">
