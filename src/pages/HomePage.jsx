...
const HomePage = () => {
    const { monthlySummaries, isBalanceLoading } = useBalance();
    const { user } = useAuth();
    ...
    // Get the correct summary (for Nicky, Alex, or Household) for the current month
    const currentMonthSummary = monthlySummaries[currentMonthString]?.[viewingAs] || { totalIncome: 0, totalExpense: 0, closingBalance: 0 };
    ...
    return (
        <div className="page-content">
            <div className="tabs view-switcher">
                {/* Add "Household" to the list of views */}
            ...
            <div className="top-balance-container">
                <h2>{viewingAs}'s Balance ({now.toLocaleString('de-DE', { month: 'long' })})</h2>
